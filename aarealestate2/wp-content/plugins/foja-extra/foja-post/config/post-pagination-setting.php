...
add_action( 'elementor/element/foja-post-block/section_foja_post_pagination_style_setting/after_section_start', function( $element, $args ) {
	...
	$element->add_control(
		...
		[
			...
			'options' => [
				'post_pagination_none' => __( 'No Pagination', 'foja' ),
				'post_pagination_number' => __( 'Pagination Number', 'foja' ),
				'post_pagination_nexprev'=> __( 'Pagination Next/Prev', 'foja' ),
				'post_pagination_infinite'=> __( 'Pagination Infinite', 'foja' ),
			],
		]
	);
