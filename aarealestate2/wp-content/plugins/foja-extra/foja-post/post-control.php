...
class foja_post_block extends Widget_Base {

	public function get_name() {
		return 'foja-post-block';
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_foja_post_block_element_setting',
			[
		...
		$this->add_control(
			'post_pilih_layout',
			[
				'label' => __( 'Post Layouts', 'foja' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'post_grid_layout',
				'options' => [
					'post_grid_layout' => __( 'Post Grid', 'foja' ),
					'post_masonry_layout'=> __( 'Post Masonry', 'foja' ),
				],
			]
		);
		...
		$this->add_control(
			'post_grid_style',
			[
				'label' => __( 'Post Grid Styles', 'foja' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'post_grid_style1',
				'options' => [
					'post_grid_style1' => __( 'Post Grid 1', 'foja' ),
					'post_grid_style2' => __( 'Post Grid 2', 'foja' ),
					'post_grid_style3' => __( 'Post Grid 3', 'foja' ),
					'post_grid_style4' => __( 'Post Grid 4', 'foja' ),
					'post_grid_style5' => __( 'Post Grid 5', 'foja' ),
				],
				'condition' => [
		...
		$this->add_control(
			'post_masonry_style',
			[
				'label' => __( 'Post Masonry Styles', 'foja' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'post_masonry_style1',
				'options' => [
					'post_masonry_style1' => __( 'Post Masonry 1', 'foja' ),
				],
				'condition' => [
		...
		/*-----------------------------------------------------------------------------------*/
		$this->start_controls_section(
			'section_foja_post_block_post_setting',
			[
		...
		/*-----------------------------------------------------------------------------------*/
		$this->start_controls_section(
			'section_foja_post_block_layout_setting',
			[
		...
		/*-----------------------------------------------------------------------------------*/
		$this->start_controls_section(
			'section_foja_post_block_image_setting',
			[
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'For Default Post Style, only work when assigned as horizontal item.', 'foja' ),
				'condition' => [
		...
		$this->add_responsive_control(
			'allow_float_img',
			[
				'label' => __( 'Make Image Above Text', 'foja' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'left',
				'options' => [
					'left' => __( 'Image Beside Content', 'foja' ),
					'none' => __( 'Image Above Content', 'foja' ),
				],
				'selectors' => [
		...
		/*-----------------------------------------------------------------------------------*/
		$this->start_controls_section(
			'section_foja_post_block_scroll_setting',
			[
		...
		/*-----------------------------------------------------------------------------------*/
		$this->start_controls_section(
		'section_foja_post_block_title_style_setting',
			[
		...
		$this->add_control(
			...
			[
				'label' => __( 'Title Hover Color', 'foja' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#666666',
				'selectors' => [
		...
		$this->add_responsive_control(
			'title_min_height',
			[
				'label' => __( 'Title Minimum Height', 'foja' ),
				'description' => __( 'Use in case you want to make all title have same height.', 'foja' ),
		...
		/*====== 6.1. Category Style Setting =======*/
		$this->start_controls_section(
		'section_foja_post_block_category_style_setting',
			[
		...
		$this->add_control(
			'use_category',
			[
				'label' => __( 'Use Category Text', 'foja' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => 'Use',
				'label_off' => 'No',
				'return_value' => 'on',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Category Border Color', 'foja' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Category Text Color', 'foja' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#fdca1f',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Category Background Color', 'foja' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#61c436',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Category Link Hover Color', 'foja' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Category Background Hover', 'foja' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#61c436',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-item .meta-wrapper span.standard-post-categories, {{WRAPPER}} .standard-post-categories a, {{WRAPPER}} .post-masonry-style .loop-content .category a, {{WRAPPER}} .category-main-news-1 a',
				'condition' => [
					'use_category' => 'on',
				],
			]
		...
		/*====== 6.2. Author Style Setting =======*/
		$this->start_controls_section(
		'section_foja_post_block_author_style_setting',
			[
		...
		$this->add_control(
			...
			[
				'label' => __( 'Author Text Color', 'foja' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Author Link Hover Color', 'foja' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		/*====== 6.3. Date Style Setting =======*/
		$this->start_controls_section(
		'section_foja_post_block_date_style_setting',
			[
		...
		$this->add_control(
			...
			[
				'label' => __( 'Date Text Color', 'foja' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
					'{{WRAPPER}} .date span, {{WRAPPER}} .date a, {{WRAPPER}} .blog-item .meta-wrapper span.date.boxed:before, {{WRAPPER}} .post-masonry-style .loop-content .date.boxed, {{WRAPPER}} .main-news-5 .post-content .post-date' => 'color: {{VALUE}};',
				],
				'condition' => [
					'use_date' => 'on',
		...
		$this->add_control(
			'date_link_hov_color',
			[
				'label' => __( 'Date Link Hover Color', 'foja' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Date Font Setting', 'foja' ),
		...
		/*-----------------------------------------------------------------------------------*/
		$this->start_controls_section(
		'section_foja_post_block_excerpt_style_setting',
			[
		...
		$this->add_control(
			'use_excerpt',
			[
				'label' => __( 'Use Excerpt Block', 'foja' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => 'Use',
				'label_off' => 'No',
				'return_value' => 'on',
		...
		/*-----------------------------------------------------------------------------------*/
		$this->start_controls_section(
		'section_foja_post_block_readmore_style_setting',
			[
		...
		$this->add_control(
			...
			[
				'label' => __( 'Read More Title Color', 'foja' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#adadad',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Read More Background Color', 'foja' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Read More Background Hover', 'foja' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#000000',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Read More Hover Background Color', 'foja' ),
				'type' => Controls_Manager::COLOR,	
				'default' => '#fdca1f',
				'selectors' => [
					'{{WRAPPER}} a.read-more:hover' => 'background-color: {{VALUE}}; border: 2px solid {{VALUE}}',
				],
				'condition' => [
					'use_read_more' => 'on',
					'post_grid_style' => 'post_grid_style1',
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Read More Font Setting', 'foja' ),
		...
		/*-----------------------------------------------------------------------------------*/
		$this->start_controls_section(
			'section_foja_post_pagination_style_setting',
			[
	...
	protected function render() {
		...
		$read_more_text 	= ! empty( $instance['read_more_text'] ) ? $instance['read_more_text'] : 'Read More';
		...
		if($post_pilih_layout == 'post_grid_layout') {
			if($post_grid_style == 'post_grid_style1') {
				include ( plugin_dir_path(__FILE__).'tpl/post-grid1-style.php' );
			}
...
Plugin::instance()->widgets_manager->register_widget_type( new foja_post_block() );