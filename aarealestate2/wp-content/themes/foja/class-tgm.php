...
add_action( 'tgmpa_register', 'foja_register_required_plugins' );
 ...
 */
function foja_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'     				=> esc_html__( 'Foja Extra', 'foja' ), // The plugin name
			'slug'     				=> 'foja-extra', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory() . '/plugins/foja-extra.zip', // The plugin source
		...
		array(
			'name'     				=> esc_html__( 'Contact Form 7', 'foja' ), // The plugin name
		...
		array(
			'name'     				=> esc_html__( 'ACF Pro', 'foja' ), // The plugin name
		...
		array(
			'name'     				=> esc_html__( 'Redux Framework', 'foja' ), // The plugin name
		...
		array(
			'name'     				=> esc_html__( 'Elementor', 'foja' ), // The plugin name
		...
		array(
			'name'     				=> esc_html__( 'One Click Demo Import', 'foja' ), // The plugin name
		...
		array(
            'name'                     => esc_html__( 'Preloader Awesome', 'foja' ), // The plugin name
