...
$site_bg_color->title = esc_html__( 'Background Color', 'foja' );
...
$wp_customize->get_section( 'header_image' )->title = esc_html__( 'Blog Header Image', 'foja' );
...
$site_logo->description = esc_html__( 'The site logo is used as a graphical representation of your company name. Recommended size: 105 (width) x 75 (height) pixels(px).', 'foja' );
$site_logo->label       = esc_html__( 'Site logo', 'foja' );
...
$wp_customize->add_panel( $panel_id, array(
	...
	'theme_supports' => '',
	'title'          => esc_html__( 'General Options', 'foja' ),
	'description'    => esc_html__( 'You can change the site layout in this area as well as your contact details (the ones displayed in the header & footer) ', 'foja' ),
) );
