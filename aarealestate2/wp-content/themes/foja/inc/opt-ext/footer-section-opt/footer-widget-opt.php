...
function foja_footer_widget_ext_opt() {

	$foja_footer_widget_opt = array(
		...
		array(
			...
			'type' => 'image_select',
			'compiler'=>true,
			'title' => esc_html__('Footer Widget Layout', 'foja'), 
			'subtitle' => esc_html__('Select footer and widget alignment. Choose between 1, 2, 3 or 4 column layout.', 'foja'),
			'options' => array(
		...
		array(
			...
			'units_extended'=> 'true',
			'display_units' => 'true',
			'title'    => esc_html__( 'Padding Footer Widget', 'foja' ),
			'default'  => array(
				'padding-top'    => '0',
				'padding-right'  => '0',
				'padding-bottom' => '0',
		...
		array(
			...
			'units_extended'=> 'true',
			'display_units' => 'true',
			'title'    => esc_html__( 'Padding Footer Bottom', 'foja' ),
			'default'  => array(
				'padding-top'    => '0',
				'padding-right'  => '0',
				'padding-bottom' => '0',
		...
		array(
			...
			'type'     => 'border',
			'title'    => esc_html__( 'Footer Widget Border', 'foja' ),
		...
		array(
			...
			'type'     => 'border',
			'title'    => esc_html__( 'Footer Bottom Border', 'foja' ),
