...
<div class="elementor-image-gallery custom-gallery clearfix">
	...
	<div id="lightgallery-<?php echo $rand2; ?>" class="gallery gallery-columns-<?php echo $settings['gallery_columns']; ?>">
	<?php

	if($gallery_source == 'gallery_meta_box')  {
		$gal_images = get_field('foja_gallery');
	}
	else {
	...
	'use strict';
		...
		$(document).ready(function() {
			$("#lightgallery-<?php echo $rand2; ?>").lightGallery({
