...
<div class="post-grid-style3 blog-section main-news-5 clearfix">
	...
	if ($sec_hook->have_posts()) : while($sec_hook->have_posts()) : $sec_hook->the_post();
		 if(has_post_thumbnail()) { 
            ...
            $image_blogblog = wp_get_attachment_image_src( get_post_thumbnail_id(), 'gedung-post-block' );
				...
				<div class="post-content">
					...
					if($use_author == 'on') { ?>
						<div class="post-author-name">
							<span><?php esc_html_e( 'by', 'foja' ); ?></span> <?php echo get_the_author_meta( 'display_name' ); ?>
						</div>
					<?php }
