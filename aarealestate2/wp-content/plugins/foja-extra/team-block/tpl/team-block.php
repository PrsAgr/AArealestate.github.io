	...
	<div class="team-block-wrap">
		...
		<?php 
			...
			if($image1) {
				...
				$image12 = wp_get_attachment_image_src($team_id, 'foja-team'); 
	            $image1 = $image12[0];
			}

			$team_name = $team['team_name'];
			$team_job = $team['team_job'];
			$foja_team_facebook 		= $team['team_facebook']['url'];
			$foja_team_twitter 		= $team['team_twitter']['url'];
			$foja_team_instagram 		= $team['team_instagram']['url'];
			$foja_team_google_plus 	= $team['team_googleplus']['url'];
		?>
			...
			<div class="team-inner-block clearfix">
				...
				<div class="team-details">
					...
					<div class="team-socials clearfix">
						<ul>
							<?php if(!empty($foja_team_facebook)){ ?>
								<li>
									<a href="<?php echo esc_url( $foja_team_facebook ); ?>">
										<i class="icon icon-themify-17"></i>
									</a>
								</li>
							<?php }
							if(!empty($foja_team_twitter)){ ?>
								<li>
									<a href="<?php echo esc_url( $foja_team_twitter ); ?>">
										<i class="icon icon-themify-13"></i>
									</a>
								</li>
							<?php }
							if(!empty($foja_team_instagram)){ ?>
								<li>
									<a href="<?php echo esc_url( $foja_team_instagram ); ?>">
										<i class="icon icon-social-instagram-outline"></i>
									</a>
								</li>
							<?php }
							if(!empty($foja_team_google_plus)){ ?>
								<li>
									<a href="<?php echo esc_url( $foja_team_google_plus ); ?>">
